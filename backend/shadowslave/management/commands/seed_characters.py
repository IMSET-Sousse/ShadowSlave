...
class Command(BaseCommand):
    help = 'Seeds the database with predefined characters'
    ...
    def handle(self, *args, **kwargs):
        ...
        for char in characters:
            Characters.objects.get_or_create(**char)

        self.stdout.write(self.style.SUCCESS('Characters seeded successfully.'))
